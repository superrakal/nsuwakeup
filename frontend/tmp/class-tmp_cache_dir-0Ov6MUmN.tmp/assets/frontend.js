  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        statements: [
          ["content","syurup.name",["loc",[null,[1,353],[1,368]]]]
        ],
        locals: ["syurup"],
        templates: []
      };
    ...
    var child2 = (function() {
      return {
        ...
        statements: [
          ["element","action",["confirm"],[],["loc",[null,[1,1047],[1,1067]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        var element1 = dom.childAt(fragment, [1, 0, 1, 0]);
      ...
      statements: [
        ["content","model.id",["loc",[null,[1,231],[1,243]]]],
        ["content","model.drink.name",["loc",[null,[1,252],[1,272]]]],
        ["content","model.drink.volume",["loc",[null,[1,279],[1,301]]]],
        ["block","each",[["get","model.syurups",["loc",[null,[1,338],[1,351]]]]],[],0,null,["loc",[null,[1,320],[1,383]]]],
        ["content","model.drink.price",["loc",[null,[1,392],[1,413]]]],
        ["inline","textarea",[],["value",["subexpr","@mut",[["get","model.comments",["loc",[null,[1,565],[1,579]]]]],[],[]],"placeholder","Оставьте Ваши пожелания и мы постараемся их воплотить в жизни"],["loc",[null,[1,548],[1,657]]]],
        ["block","if",[["get","isConfirmed",["loc",[null,[1,721],[1,732]]]]],[],1,2,["loc",[null,[1,715],[1,1136]]]]
      ],
      locals: [],
...
define('frontend/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"frontend","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"frontend","version":"0.0.0+ee190875"},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","contentSecurityPolicy":{"default-src":"'none'","script-src":"'self' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","img-src":"'self'","style-src":"'self'","media-src":"'self'"},"exportApplicationGlobal":true}};
});

if (runningTests) {
  require("frontend/tests/test-helper");
} else {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+ee190875"});
}
